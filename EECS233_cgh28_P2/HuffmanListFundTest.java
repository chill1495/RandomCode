...
public class HuffmanListFundTest {
	...
	public void testStringArgumentConstructor()throws IOException {
		...
		HuffmanList list = new HuffmanList("C:\\Users\\cours_000\\Data Structures\\file.txt"); // aaaabbbcc\n
		HuffmanNode hNode;
	...
	public void testIterator() throws IOException {
		HuffmanList list = new HuffmanList("C:\\Users\\cours_000\\Data Structures\\file.txt"); // aaaabbbcc (and a new line '\n')
	...
	public void testByteAndIntegerArrayConstructor() {
		try	{
			...
			HuffmanNode hNode = iter.next();
				assertEquals(
					"The #1 element in the HuffmanList, constructed from arrays should be character \'a\'.",
					(byte)'a', hNode.b);
				assertEquals(
					"The count of #1 element, \'a\', in the HuffmanList, constructed from arrays, should be 1.",
					1, hNode.count);
				hNode = iter.next();
				assertEquals(
						"The #2 element in the HuffmanList, constructed from arrays should be character \'b\'.",
						(byte)'b', hNode.b);
					assertEquals(
						"The count of #2 element, \'a\', in the HuffmanList, constructed from arrays, should be 2.",
						2, hNode.count);
		} 
		catch (Exception e) {
			assertTrue("the arrays do not meet specifications", false);
		}
	}
}